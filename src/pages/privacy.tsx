      ...
      <main>
        <div className="border border-gray-200 rounded-xl bg-white shadow-sm overflow-hidden">
          <div className="text-xs text-muted px-3 pt-2.5">
            <Link href="/" className="underline underline-offset-2">トップ</Link> / 個人情報保護方針
          </div>
          <div className="p-3">
            <div className="border border-gray-200 rounded-[14px] p-3 bg-white m-3">
              <h1 className="m-0 mb-1.5 text-base font-extrabold">個人情報保護方針</h1>
              <div className="text-xs text-muted">ここに個人情報保護方針本文を配置します。</div>
